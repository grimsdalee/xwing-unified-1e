        ...
        string? shipId)
    {
                ...
                StringComparison.OrdinalIgnoreCase))
        {
            ...
            return new ProductionValidationProfile(
                ...
                "assets/source/unified1e/bases/epic/base-short.obj",
                "assets/source/unified1e/bases/pegs/epic-short.obj",
                "assets/source/unified1e/ships/epic/croccruiser/croc-doublesided-test.obj",
                Path.Combine(
                    repositoryRoot,
                    "assets",
                    "source",
                ...
                3.497615,
                "crcshp",
                "Diagnostic double-sided C-ROC Cruiser mesh at the authoritative reference Epic peg-top height.",
                ...
                "This validation uses a diagnostic double-sided C-ROC mesh to test the inherited open/single-sided geometry defect.\n" +
