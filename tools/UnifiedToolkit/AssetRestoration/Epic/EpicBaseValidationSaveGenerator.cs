        ...
        string? shipId)
    {
                ...
                StringComparison.OrdinalIgnoreCase))
        {
            ...
            return new ProductionValidationProfile(
                ...
                "assets/source/unified1e/bases/epic/base-short.obj",
                "assets/source/unified1e/bases/pegs/epic-short.obj",
                "assets/source/unified1e/ships/epic/croccruiser/croc-interior-shell-test.obj",
                Path.Combine(
                    repositoryRoot,
                    "assets",
                    "source",
                ...
                3.497615,
                "crcshp",
                "Diagnostic C-ROC Cruiser mesh with a double-sided interior backstop shell at the authoritative reference Epic peg-top height.",
                ...
                "This validation uses a diagnostic double-sided C-ROC mesh with a hidden interior backstop shell to cover inherited missing geometry.\n" +
